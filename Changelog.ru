...
+ Добавлена переменная BonusHtHDamageFix (по умолчанию = 1) - эффект взятого перка 'Бонус рукопашного урона' накладывается не только на максимальный, но и минимальный дамаг холодным оружием/без оружия.
